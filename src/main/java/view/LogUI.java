...
public class LogUI extends JPanel {
    ...
    private JPanel createTablePanel() {
        ...
        DefaultTableCellRenderer amountRenderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                setForeground(type.equals("Income") ? INCOME_COLOR : EXPENSE_COLOR);
                c.setBackground(isSelected ? ACCENT_COLOR : PANEL_COLOR);
                return c;
            }
        };
        ...
        scrollPane.getVerticalScrollBar().setUI(new javax.swing.plaf.basic.BasicScrollBarUI() {
            ...
            protected void configureScrollBarColors() {
                thumbColor = new Color(100, 80, 140);
                trackColor = new Color(24, 15, 41);
            }
        });
    ...
    public static LogUI getInstance() {
        if (instance == null) {
            instance = new LogUI(getInstance().userId);
        }
        return instance;
    }
}
